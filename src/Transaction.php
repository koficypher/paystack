...
class Transaction extends Executor {
     ...
     */
    public function initialize(array $data, array $params = null, string $seckey = null): Response
    {
    ...
    public function charge_authorization(array $data, string $seckey = null): Response
    {
    ...
    public function check_authorization(array $data, string $seckey = null): Response
    {
    ...
    public function view_trans_timeline(string $id_or_reference): Response
    {
    ...
    public function trans_totals(int $per_page = 50, int $page = 1): Response // TODO: Add the to and from datetimes
    {
    ...
    public function export_trans(int $per_page = 50, int $page = 1): Response // TODO: Add other path params
    {
    ...
    public function partial_debit(array $data, string $seckey = null): Response
    {
